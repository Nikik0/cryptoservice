...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, KafkaMessageDto> producerFactory(KafkaProperties kafkaProperties, ObjectMapper mapper) {
...
//        properties.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, JsonSerializer.class);
        ...
        var kafkaProducerFactory = new DefaultKafkaProducerFactory<String, KafkaMessageDto>(properties);
    ...
    @Bean
    public KafkaTemplate<String, KafkaMessageDto> kafkaTemplate(ProducerFactory<String, KafkaMessageDto> producerFactory) {
